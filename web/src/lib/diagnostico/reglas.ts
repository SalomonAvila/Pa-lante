 ...
 *
 * Movido desde mcp/src/lib/reglas.ts: tanto el servidor MCP como el
 * orquestador conversacional (web/src/lib/inteligencia/) lo importan desde
 * acá, así que el umbral vive en un solo lugar.
 */
