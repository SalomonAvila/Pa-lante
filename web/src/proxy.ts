...
// "/intake" SÍ requiere sesión (decisión revertida): el flujo ahora es
// login → conversación de voz → expertos, y la recolección necesita saber
// de quién son los hallazgos que va guardando.
